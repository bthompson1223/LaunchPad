...
const CreateReward = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (amount < 1)
      validationErrors.amount = "Pledge amount must be a positive figure";
    if (!estDeliveryDate)
      validationErrors.estDeliveryDate = "Estimated Delivery Date is required";
    ...
    if (quantity < 1)
      validationErrors.quantity = "Reward quantity must be a positive figure";
  ...
  return (
    <div className="reward-add-edit">
      ...
      <form
        className="reward-add-edit-form"
      ...
      >
        ...
        <div className="reward-input-div">
          ...
          <label htmlFor="image">
            <input type="file" accept="image/*" onChange={fileWrap} />
          </label>
          <div className="reward-errors">
            {image === maxFileError && <p>{image}</p>}
