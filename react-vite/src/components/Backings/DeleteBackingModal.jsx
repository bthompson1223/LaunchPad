...
export const DeleteBackingModal = ({ backing }) => {
  ...
  return (
    <div className='delete-project-modal'>
      ...
      <button id='project-delete-yes-btn' onClick={handleDelete}>Yes (Delete Backing)</button>
      <button id='project-delete-no-btn' onClick={handleCancel}>No (Keep Backing)</button>
    </div>
  );
}